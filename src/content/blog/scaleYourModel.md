...
modDatetime: 2026-03-24T13:00:00
...
对于 sequence length $T$ 小于 8 倍的 hidden dimension $D$ 的情况 ($T \lt 8D$)，MLP 模块的参数量就主导了总参数量，MLP 模块也主导了 FLOPs 预算。
...
<img src="https://jax-ml.github.io/scaling-book/assets/img/transformer-layer-1400.webp" alt="simplified transformer" width="500" />


将两个前馈网络 FFW 块视为两个矩阵 $W_{in}$ 和 $W_{out}$ 的堆叠。
